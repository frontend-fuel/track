...
// Initialize the map with default coordinates (Chittoor, Andhra Pradesh)
let map = L.map('map').setView([13.2172, 79.1003], 15);
...
// Add marker at the default coordinates
let marker = L.marker([13.2172, 79.1003], { icon: glassesIcon }).addTo(map);
marker.bindPopup('Smart Glasses Location<br>Lat: 13.2172<br>Lng: 79.1003').openPopup();
